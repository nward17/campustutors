<?php
	...
	*/
	...
	$language[64]			=	"More Applications";						// Displayed under bookmarks (non-bookmarks heading)
	...
	$language[213]			=	"Type a message...";													// Displayed in the input box to message someone
	...
	$language[176]			=	"Current Sessions";			// Displays in the header for the recent chat list
