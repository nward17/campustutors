.arrowchat_bar_button,#arrowchat_buddy_list_tab,.arrowchat_apps_button,.arrowchat_tray_button,#arrowchat_show_bar_button,#arrowchat_chatbox_left{-webkit-box-shadow:none;background:#<?php echo $bar_background; ?>;color:#<?php echo $bar_text; ?>}
...
#arrowchat_base{border-left:1px solid #<?php echo $bar_background; ?>;border-right:1px solid #<?php echo $bar_background; ?>;border-bottom: 0}
.arrowchat_tabmouseover,.arrowchat_chatbox_lr_mouseover{background-color:#<?php echo $bar_hover; ?> !important}
#arrowchat_applications_button,.arrowchat_tray_button{border-right:1px solid #<?php echo $bar_border; ?>}
...
#arrowchat_buddy_list_tab{border-right:1px solid #<?php echo $bar_border; ?> !important}
